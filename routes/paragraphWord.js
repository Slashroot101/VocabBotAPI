...
router.use(function (req, res, next) {
    console.log('Checking middleware functions in stringWord!');
...
//saves a paragraphWord if one doesn't already exist matching it, if it does, it skips saving it, and does not reward any points
router.post('/create', function (req, res, next) {
    console.log(`Posting string word!`);
    var newWord1 = new paragraphWord({
    ...
    var newWord2 = new paragraphWord({
        prompt: req.body.prompt,
        choices: {
            a1: req.body.a4,
            a2: req.body.a3,
    ...
    var newWord3 = new paragraphWord({
        prompt: req.body.prompt,
        choices: {
            a1: req.body.a4,
            a2: req.body.a2,
    ...
    var newWord4 = new paragraphWord({
        prompt: req.body.prompt,
        choices: {
            a1: req.body.a1,
            a2: req.body.a3,
